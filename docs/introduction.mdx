...
WasmKit is a development framework for building CosmWasm contracts. The aim of the project is to make contracts development process simple, efficient and scalable. User can focus on logic of contract and not much about further steps in development.
